...
2. **Confirm scope.** Show the user the spec's Goal, Non-goals, and Files sections in under 15 lines and ask whether to proceed. Skip this step only if the user said "no confirmation" in the arguments.
