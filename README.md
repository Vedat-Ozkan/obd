...
|---|---|---|---|
| 0 | Sep 16 – Oct 16, 2026 | **Core, BLE, and the codes report.** ELM327 session, standard decoding, the phone app with a debug console, a phone relay that exposes the car to agents through MCP, and a codes / "recently cleared" report every battery report includes. | Chrysler 200, Elantra (test bench). Equinox EV: spike. |
...
| Item | Detail | Notes |
|---|---|---|
| 2013 Chrysler 200 | ICE, CAN 11-bit/500k | Core test car: session, standard decoding, codes report |
| 2019 Hyundai Elantra Preferred | ICE, CAN 11-bit/500k | Second core test car |
