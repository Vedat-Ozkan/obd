...
- For BM1–BM7 and the LLM features (T2.10, T2.11), read `docs/ML.md` and `docs/EVAL.md`: preserve split isolation and provenance, separate real/synthetic results, and never treat a missing training or eval run as a vehicle hardware-only exception.
